...
Note that osc-cli depends on M2Crypto library for some features. Please check [associated dependancies](https://github.com/mcepl/M2Crypto/blob/master/INSTALL.rst).
